        ...
        <div className="bg-white rounded-2xl shadow-xl overflow-hidden">
          ...
          <div className={`p-8 ${theme.formBackground}`}>
            ...
            <form onSubmit={handleSubmit} className="space-y-6">
              <div>
                <label className="block text-gray-800 text-sm font-medium mb-2">Usuario</label>
                <div className="relative">
                  ...
                  <input
                    ...
                    className={`pl-10 w-full px-4 py-3 border ${theme.inputBorder} rounded-lg ${theme.inputFocusRing}`}
              ...
              <div>
                <label className="block text-gray-800 text-sm font-medium mb-2">Contraseña</label>
                <div className="relative">
                  <div className="absolute inset-y-0 left-0 pl-3 flex items-center pointer-events-none">
                    <svg className="h-5 w-5 text-gray-800" fill="currentColor" viewBox="0 0 20 20">
                  ...
                  <input
                    ...
                    onChange={handleChange}
                    className={`pl-10 pr-12 w-full px-4 py-3 border ${theme.inputBorder} rounded-lg ${theme.inputFocusRing}`}
              ...
              <button
                type="submit"
                disabled={loading}
                className={`w-full bg-gradient-to-r ${theme.buttonGradient} text-white font-medium py-3 px-4 rounded-lg ${theme.buttonHoverGradient} transition-all disabled:opacity-50`}
              >
